...
- Improved architecture documentation to reflect the actual runtime data flow (`readsb` → PLAO / `adsb-eval` → ARENA)
...
- Updated `.gitignore` to better exclude generated artifacts while preserving public sample data and documentation assets
