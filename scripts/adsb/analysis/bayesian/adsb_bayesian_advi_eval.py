...
def run_bayesian_advi():
    log.info(" ADS-B Fast Bayesian Engine (ADVI Approximation)")
    ...
    log.info(f"--- {cutoff.date()} Fast ADVI improvement probability with cutoff at ---")
    ...
    if prob_improved > 90:
        log.info(" Improvement is almost certain.")
    elif prob_improved > 70:
        log.info(" There are signs of improvement (confidence ≥ 70%).")
    else:
        log.info(" Insufficient evidence of improvement, or not enough data.")
